...
///************************************************///
		...
		total *= 1000;
		//fprintf(fout,"arquivo ordenado pelo algoritmo balanced merge sort tempo da ordenação = %Lf milissegundos\n\n",total);
		fclose(fout);
		fclose(fin);
